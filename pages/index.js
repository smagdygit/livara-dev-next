				...
				<div className="container mt-4" style={{ minHeight: 'calc(100vh - 431px)' }}>
					<div className="container" style={{ margin: '0', borderRadius: '10px' }}>
						<div className="mb-5">
							...
							<p>Vad roligttttttt att du hittat hit. Vi på Livara Hemtjänst erbjuder omsorg av högsta kvalité i alla dess former. Livara Hemtjänst är ett omsorgsföretag som blivit godkända att utföra hemtjänst av Göteborgs stad. Vår verksamhet startade i början av 2019 och har tillfredsställt göteborgarnas behov sedan dess. Nu erbjuder vi hemtjänst i stora delar av Göteborg, däribland Hisingen, Angered och Östra Göteborg. Är du osäker på om vi utför hemtjänst i ditt område? Kontakta oss gärna så berättar vi mer!</p>
