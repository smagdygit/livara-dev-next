	...
	return (
		<>
			...
			<div>
				...
				<p>Kontakta oss på Livara omsorg och berätta om dina behov och viljor så ser vi till att göra en vattentät och välfungerande planering, med dig som kund i fokus. 
					När du känner dig nöjd och har fått en tydlig förståelse över ditt nya val, då kontaktar du helt enkelt din biståndsbedömare och begär att få byta hemtjänst-utförare till Livara omsorg! 
					biståndsbedömaren kontaktar oss sedan och bekräftar ditt val. Uppstart sker efter överenskommelse. Tveka inte på att kontakta oss för hjälp eller ytterligare information. 
				</p>
				<br />
				<p>Massa kärlek</p>
				<p>Livara Omsorg</p>
