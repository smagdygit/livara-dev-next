...
function App() {
	...
	return (
		<>
			...
			<center>
				<h2>
					<b>Hur jobbar vi på Livara Omsorg?</b>
				</h2>
				<Divider />
				<br />
			</center>
			<div>
				...
				<p>Vi på Livara gör alltid vårt yttersta för att du som kund ska få det precis som du önskar. I de fall det inte är möjligt kompromissar vi fram den näst bästa lösningen för dig till dina främsta önskemål går att uppfylla. Du är i trygga händer helt enkelt.</p>
