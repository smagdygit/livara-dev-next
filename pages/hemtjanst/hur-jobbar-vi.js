	...
	return (
		<>
			...
			<div>
				...
				<p>På Livara är vi väl medvetna om hur viktigt det är med stabilitet och relationsskapande. Vi har därför utvecklat en metod som går ut på att varje kund har ett fåtal personer runt sig som fokusgrupp, och beroende på hur mycket hemtjänst du som kund får utfört kan det variera mellan 1 - 4 personer. Detta skapar den nära relation som behövs i skapandet av trygghet och välmående i hemmet.</p>
				<br />
